...
export const translations = {
  de: {
    ...
    // dashboard
    dashGreeting: 'Hallo',
    dashSubtitle: 'Schön, dass du wieder da bist. Lass uns weiterlernen.',
    dashDayStreak: 'Tage in Folge',
    dashProgressTo: 'Fortschritt zu Level',
    dashXpToGo: 'XP fehlen',
    dashPracticeToday: 'Was möchtest du heute üben?',
    dashReviewVocab: 'Vokabeln wiederholen',
    dashDueCards: 'Karteikarten heute fällig',
    dashPracticeNow: 'Jetzt üben',
    dashRecentActivity: 'Letzte Aktivitäten',
    dashNoActivity: 'Noch keine Aktivitäten. Mach deine erste Übung!',
    dashWeakSpots: 'Deine Schwachstellen',
    dashCorrect: 'richtig',
    dashPracticeThis: 'Gezielt üben →',
    dashAllGood: 'Alles im grünen Bereich!',
    dashNoData: 'Wir haben noch nicht genug Daten für Schwachstellen.',
    dashYouHave: 'Du hast',
  },
  en: {
    appName: 'DeutschPraxis',
    ...
    // dashboard
    dashGreeting: 'Hello',
    dashSubtitle: 'Great to have you back. Let\'s keep learning.',
    dashDayStreak: 'Day streak',
    dashProgressTo: 'Progress to level',
    dashXpToGo: 'XP to go',
    dashPracticeToday: 'What do you want to practise today?',
    dashReviewVocab: 'Review vocabulary',
    dashDueCards: 'flashcards due today',
    dashPracticeNow: 'Practice now',
    dashRecentActivity: 'Recent activity',
    dashNoActivity: 'No activity yet. Complete your first exercise!',
    dashWeakSpots: 'Your weak spots',
    dashCorrect: 'correct',
    dashPracticeThis: 'Practice this →',
    dashAllGood: 'All looking good!',
    dashNoData: 'Not enough data for weak spots yet.',
    dashYouHave: 'You have',
  },
} as const;
